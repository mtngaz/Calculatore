...
void operator_check_str(const char* str, int* error, int i) {
  if (str[0] == '/' || str[0] == '*' || str[0] == '^' || str[0] == 'm' || str[0] == '.') {
    *error = 1;
  ...
  if ((number_check(str[i]) && str[i + 1] == '.' && number_check(str[i + 2]) && str[i + 3] == '.') || (str[i] == '.' && str[i + 1] == '.')){
    *error = 1;
  }else if ((number_check(str[i]) && str[i + 1] == '.' && str[i + 2] == 'x') || (str[i] == 'x' && str[i + 1] == '.' && number_check(str[i + 2]))){
    *error = 1;
  }
}
